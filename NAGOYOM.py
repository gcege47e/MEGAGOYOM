...
def main_menu(user_id):
    ...
    keyboard.row('📢 گزارش', '💰 خرید مکان برتر')
...
# -------------------- تابع مدیریت رای مکان --------------------
def update_votes(title, owner_id, count, score, add=True):
    """ بروزرسانی امتیاز مکان بر اساس رای ها """
    # TODO: بروزرسانی دیتابیس
    if add:
        print(f"اضافه کردن {count} رای با امتیاز {score} به مکان {title} (مالک {owner_id})")
    else:
        print(f"کم کردن {count} رای با امتیاز {score} از مکان {title} (مالک {owner_id})")

# -------------------- گرفتن مکان‌های کاربر --------------------
def get_user_places(user_id):
    """ بازگرداندن لیست مکان‌های کاربر (id, name) """
    # TODO: واکشی واقعی از دیتابیس
    return [(1, "نمونه مکان ۱"), (2, "نمونه مکان ۲")]
