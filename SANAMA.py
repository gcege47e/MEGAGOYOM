...
# Templates - Standalone HTML strings
index_template = '''
<!DOCTYPE html>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="/">مکان‌ها</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/add_place">ثبت مکان</a>
                    </li>
                    {% endif %}
                </ul>
                <ul class="navbar-nav">
                    {% if current_user.is_authenticated %}
                    <li class="nav-item">
                        <a class="nav-link" href="/profile">حساب من</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-8 mx-auto">
                <form method="GET" action="/" class="d-flex">
                    ...
                    {% if current_user.is_authenticated %}
                    <a href="/?only_my_city=true" class="btn btn-outline-primary">فقط شهرکمون</a>
                    {% endif %}
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                    {% if place.images %}
                        <img src="image/jpeg;base64,{{ place.images.split(',')[0] }}" class="card-img-top" alt="{{ place.title }}">
                    {% else %}
                    ...
                    <div class="card-footer">
                        <a href="/place/{{ place.id }}" class="btn btn-primary btn-sm">مشاهده</a>
                    </div>
                </div>
            </div>
            {% endfor %}
        ...
        <nav aria-label="صفحه‌بندی">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item">
                    <a class="page-link" href="/?page={{ pagination.prev_num }}{% if request.args.get('q') %}&q={{ request.args.get('q') }}{% endif %}{% if request.args.get('category') %}&category={{ request.args.get('category') }}{% endif %}{% if request.args.get('city') %}&city={{ request.args.get('city') }}{% endif %}">قبلی</a>
                </li>
                {% endif %}
                {% for page_num in pagination.iter_pages() %}
                    {% if page_num %}
                        ...
                        <li class="page-item">
                            <a class="page-link" href="/?page={{ page_num }}{% if request.args.get('q') %}&q={{ request.args.get('q') }}{% endif %}{% if request.args.get('category') %}&category={{ request.args.get('category') }}{% endif %}{% if request.args.get('city') %}&city={{ request.args.get('city') }}{% endif %}">{{ page_num }}</a>
                        </li>
                        {% else %}
                ...
                <li class="page-item">
                    <a class="page-link" href="/?page={{ pagination.next_num }}{% if request.args.get('q') %}&q={{ request.args.get('q') }}{% endif %}{% if request.args.get('category') %}&category={{ request.args.get('category') }}{% endif %}{% if request.args.get('city') %}&city={{ request.args.get('city') }}{% endif %}">بعدی</a>
                </li>
                {% endif %}
            </ul>
        </nav>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ place.title }} - مکان‌ها</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.rtl.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        body {
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mb-2">
                                <img src="image/jpeg;base64,{{ img }}" class="img-fluid" alt="تصویر مکان">
                            </div>
                            {% endfor %}
                        </div>
                        {% endif %}
                        ...
                        {% if current_user.is_authenticated %}
                        <form method="POST" action="/place/{{ place.id }}/rating" class="mb-4">
                            <div class="mb-3">
...
if __name__ == '__main__':
    ...
    socketio.run(app, host='0.0.0.0', port=port, debug=False) # Disable debug on Render